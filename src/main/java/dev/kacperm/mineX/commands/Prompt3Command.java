...
public class Prompt3Command implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        String json = String.format("{ \"text\": \"Write a short, fun limerick about %s exploring a magical cave in Minecraft. Include a twist ending!\", \"user\": \"%s\" }", playerName, playerName);
