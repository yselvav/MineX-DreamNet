...
implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String s, @NotNull String[] strings) {
        ...
        String json = String.format("{ \"text\": \"Compose a short bardic verse from the Kingdom of the Chain-block about the hero it needs to have a rhyme with the players name and with the possible reason that person selected that name%s\", \"user\": \"%s\" }", playerName, playerName);
