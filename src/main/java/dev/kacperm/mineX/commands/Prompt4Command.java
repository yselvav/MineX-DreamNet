...
public class Prompt4Command implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        String json = String.format("{ \"text\": \"Describe an epic battle where %s defeats a dragon using only clever tricks and teamwork, with a funny victory speech at the end.\", \"user\": \"%s\" }", playerName, playerName);
